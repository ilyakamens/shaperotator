...
export default function Radient() {
  ...
  return (
    <div
      ...
      <p>
        This is a 300x300 pixel square containing a gradient of black and white pixels. Each pixel
        in a given row's chance of color is proportional to its distance from the bottom. Press the
